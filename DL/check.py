...
parser.add_argument('--samples', help='npz file with the inputs and desired masks', type=str, default='cartas.npz')
parser.add_argument('--model', help="name of model to check", type=str, default='cartas.torch')
