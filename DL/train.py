...
parser.add_argument('--samples', help='npz archive with the inputs and desired masks', type=str, default='cartas.npz')
...
if args.model is None:
    ...
    model = torch.load(modelname, map_location=device, weights_only=False)
